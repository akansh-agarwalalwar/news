...
export default function News() {
  ...
  const fetchData = async () => {
    const data = await fetch(
      `https://newsapi.org/v2/everything?q=Apple&from=2025-01-05&sortBy=popularity&apiKey=7ecfa62bf28c4971ba96ea3db7b53fb2`
    );
      ...
      <div className="main">
        {data ? (
          <>
            ...
            <div>
              <button onClick={handlePrev} disabled={condition}>
                Prev
              </button>
              {buttonRendering()}
